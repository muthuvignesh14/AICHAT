...
const apiKey = 'ade52f7b16mshf8267e4a1be631ap16f302jsnf14e9beb1de2'; // Replace this with your actual API key
...
// Function to hide the prompt message
...
sendButton.addEventListener('click', async () => {
    ...
    handleChat(userText);
    hidePromptMessage(); // Hide prompt message when sending a message
});
...
imageButton.addEventListener('click', async () => {
    ...
    hidePromptMessage(); // Hide prompt message when generating an image
});
